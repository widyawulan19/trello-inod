...
import '../style/fitur/CardDetailDuplicate.css'

const CardDetailDuplicate=({cardId, boardId, listId, workspaceId, onClose,fetchCardList})=> {
  //STATE
  ...
  //2. fetch list berdasarkan boards
   useEffect(() => {
    ...
    return (
    <div className='dc-duplicate-container'>
...
export default CardDetailDuplicate
