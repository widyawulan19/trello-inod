...
import '../style/fitur/CardDetailMove.css';
import { useSnackbar } from '../context/Snackbar';

const CardDetailMove = ({ cardId, workspaceId, onClose, userId, currentBoardId,onCardMoved,fetchCardList}) => {
    ...
    return (
        <div className="cd-move-container">
