    ...
    <div className="rb-container">
      <div className="rb-header">
        ...
        <div className="rb-search">
          <input
            type="text"
            placeholder="Search by name, code, or buyer..."
            value={searchQuery}
      ...
      <p className="rb-subtitle">
        Semua data yang dihapus sementara ditampilkan di sini.  
      ...
      {Object.entries(filteredData).map(([key, items]) => (
        <div
          key={key}
          className="p-4 mt-4 transition-all bg-white border shadow-sm rounded-xl hover:shadow-md"
        >
