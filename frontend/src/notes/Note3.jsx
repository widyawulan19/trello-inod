...
//     FORBID_ATTR: ['style', 'class'], // hapus semua style & class inline
//     ALLOWED_TAGS: [
...
//             <button onClick={() => openLinkModal(chat.id)}>🔗</button>
//             <label className="upload-btn">📎
//               <input type="file" hidden onChange={e => handleUploadFromEditor(e, chat.id)} />
//             </label>
//             <div className="emoji-picker-wrapper">
...
//           <button onClick={() => handleFormat('unorderedList')}>•</button>
//           <button onClick={() => handleFormat('code')}><code>{`</>`}</code></button>
//           <button onClick={() => openLinkModal('main')}>🔗</button>
//           <label className="upload-btn">📎
//             <input type="file" style={{ display: "none" }} onChange={e => handleUploadFromEditor(e, "main") } />
//           </label>
//           <div className="emoji-picker-wrapper">
...
//       {/* Link modal (simple) */}
//       {linkModalOpen && (
//         <div className="link-modal-backdrop" style={{position:'fixed', inset:0, zIndex:40}} onMouseDown={closeLinkModal}>
...
//             <input placeholder="Label (optional)" value={linkLabel} onChange={e => setLinkLabel(e.target.value)} style={{display:'block', marginBottom:8, width:300}} />
//             <input placeholder="https://example.com or mailto:..." value={linkUrl} onChange={e => setLinkUrl(e.target.value)} style={{display:'block', marginBottom:8, width:300}} />
